      ...
      >
        ...
        <MenuSection label={dictionary['navigation'].formsAndTables}>
          ...
          <MenuItem
            ...
            href={`${import.meta.env.VITE_DOCS_URL}/docs/user-interface/form-elements`}
          ...
          <MenuItem
            ...
            href={`${import.meta.env.VITE_DOCS_URL}/docs/user-interface/mui-table`}
            suffix={<i className='tabler-external-link text-xl' />}
            target='_blank'
          >
        ...
        <MenuSection label={dictionary['navigation'].chartsMisc}>
          ...
          <MenuItem
            ...
            href={`${import.meta.env.VITE_DOCS_URL}/docs/user-interface/foundation`}
            suffix={<i className='tabler-external-link text-xl' />}
            target='_blank'
          >
          ...
          <MenuItem
            ...
            href={`${import.meta.env.VITE_DOCS_URL}/docs/user-interface/components`}
            suffix={<i className='tabler-external-link text-xl' />}
            target='_blank'
          >
          ...
          <MenuItem
            ...
            href={`${import.meta.env.VITE_DOCS_URL}/docs/menu-examples/overview`}
            suffix={<i className='tabler-external-link text-xl' />}
            target='_blank'
          >
